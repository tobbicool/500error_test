import { c as createComponent, r as renderTemplate, a as addAttribute, e as renderHead, f as renderSlot, b as createAstro, d as renderComponent, m as maybeRenderHead } from '../chunks/astro/server_CO2dTrhU.mjs';
import 'kleur/colors';
import 'clsx';
import { s as setupI18n, i as initI18n, $ as $$Trans } from '../chunks/Trans_CIpGmQFS.mjs';
/* empty css                                 */
import fs from 'fs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  console.log("Character count in index.astro:", characterCount);
  const i18n = await initI18n();
  const lang = setupI18n(Astro2.url.pathname);
